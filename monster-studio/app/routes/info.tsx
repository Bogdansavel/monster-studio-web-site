            ...
            <div className="col-start-2 col-span-10 text-center">
                ...
                <div className="grid grid-cols-2 gap-5">
                    <div>
                        ...
                        <img className="rounded-3xl w-96" src="MonsterP1480.gif" alt="this slowpoke moves" />
                    </div>
                    <div>
                        <p className="mb-2 text-lg">Krok 2</p>
                        <img className="rounded-3xl w-96" src="MonsterP2480.gif" alt="this slowpoke moves" />
                    </div>
